...
class History:
    ...
    def store(t, machine_id, reward):
        ...
        History.stats["reward(time)"].append(reward)
        History.stats["reward_normalized(time)"].append(History.stats["total_reward"] / t)
    ...
    def print(machine, policy):
        ...
        rn = History.stats["reward_normalized(time)"]
        print("{}".format(policy))
